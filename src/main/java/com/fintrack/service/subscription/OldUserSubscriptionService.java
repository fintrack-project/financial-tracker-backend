...
@Service
public class OldUserSubscriptionService {

    private static final Logger logger = LoggerFactory.getLogger(OldUserSubscriptionService.class);
    ...
    public OldUserSubscriptionService(
